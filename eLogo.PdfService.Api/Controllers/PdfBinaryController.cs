...
namespace eLogo.PdfService.Api.Controllers
{
    ...
    public class PdfBinaryController : ControllerBase
    {
        ...
        public PdfBinaryController(AppSettings appSettings, IIronPdfConverter ironPdfService, IWkhtmlConvertService wkhtmlConvertService)
        {
        ...
        [SwaggerOperation(OperationId = "HtmlToPdfStream")]
        ...
        [SwaggerOperation(OperationId = "HtmlToImageStream")]
        [SwaggerGroup("BinaryConversion")]
        [RequestSizeLimit((long)7 * 1024 * 1024)]
